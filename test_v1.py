...
from model.build_v1 import build_model_v1
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description="ReID5o Evaluation (build_v1)")
    parser.add_argument("--config_file", default='/15874700167/omreid/omreid/ReID5o/logs/reid5o_ckpt/configs.yaml')
    ...
    checkpointer.load(f=op.join(args.output_dir, 'last.pth'))
    model.to(device)
